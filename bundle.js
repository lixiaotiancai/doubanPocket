...
const CONFIG = {
  ...
  page: [{
    ...
    icon: 'book',
    searchPage: {
      defaultSearch: ['腾讯', 'javascript', '前端', '马克思', '奥特曼'],
...
__webpack_require__(/*! ./lib/reset.css */ "./src/lib/reset.css");

__webpack_require__(/*! ./lib/fonts/iconfont.css */ "./src/lib/fonts/iconfont.css");

__webpack_require__(/*! ./style.css */ "./src/style.css");

var _searchPage = __webpack_require__(/*! ./component/page/search-page */ "./src/component/page/search-page/index.jsx");

var _searchPage2 = _interopRequireDefault(_searchPage);

var _detailPage = __webpack_require__(/*! ./component/page/detail-page */ "./src/component/page/detail-page/index.jsx");
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.state = {
      page: 'searchPage', // 主页展示的页面: searchPage ? detailPage ? or more...
      searchPage: (0, _util.getActivePageName)(), // searchPage 展示的活动页: 图书? 电影? 音乐? or more...
      detailPageInfo: {}, // detailPage展示的详情信息
      searchPageScrollY: {} // 获取searchPageScrollY
    };
    return _this;
  }
  ...
  _createClass(App, [{
    key: 'setActiveSearchPage',
    value: function setActiveSearchPage(page) {
      this.setState({
        searchPage: page
      });
    }
    ...
    key: 'showDetailPage',
    value: function showDetailPage(item) {
      this.setState({
        page: 'detailPage', // 主页展示detailPage
        detailPageInfo: item // detailPage详情信息
      });
      window.scrollTo(0, 0);
    }
    ...
    value: function showSearchPage() {
      this.setState({
        page: 'searchPage' // 主页展示searchPage
      });
    }

    // 获取searchPage的scrollY

  }, {
    key: 'getSearchPageScrollY',
    value: function getSearchPageScrollY(scrolly) {
      this.setState({
        searchPageScrollY: scrolly
      });
    }
  }, {
    key: 'render',
    value: function render() {
      // 搜索页与详情页间的切换
      var showPage = this.state.page;

      var showSearchPage = showPage === 'searchPage';
      var showDetailPage = showPage === 'detailPage';

      var searchPageCls = showSearchPage ? '' : 'searchPage-hidden';
      var detailPageCls = showDetailPage ? '' : 'detailPage-hidden';

      // 详情页面信息
      var detailPageInfo = this.state.detailPageInfo;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: searchPageCls },
          _react2.default.createElement(_searchPage2.default, {
            activeSearchPage: this.state.searchPage,
            setActiveSearchPage: this.setActiveSearchPage.bind(this),
            showDetailPage: this.showDetailPage.bind(this),
            getSearchPageScrollY: this.getSearchPageScrollY.bind(this)
          })
        ),
        _react2.default.createElement(
          'div',
          { className: detailPageCls },
          _react2.default.createElement(_detailPage2.default, {
...
/***/ "./src/component/components/footer/index.css":
/*!***************************************************!*\
  !*** ./src/component/components/footer/index.css ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/component/components/footer/index.jsx":
/*!***************************************************!*\
  !*** ./src/component/components/footer/index.jsx ***!
  \***************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.css */ "./src/component/components/footer/index.css");

var _item = __webpack_require__(/*! ./item */ "./src/component/components/footer/item.jsx");
...
var Footer = function (_Component) {
  ...
  function Footer() {
    ...
    _this.state = {
      activeItem: (0, _util.getActivePageName)() // 当前被选中的item
    };
    return _this;
  }
  ...
  _createClass(Footer, [{
    ...
    value: function setScrollY() {
      var key = this.state.activeItem;
      var scrollY = this.props.scrollY;

      window.scrollTo(0, scrollY[key]);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var setPage = this.props.setPage; // 设置页面跳转

      var page = _CONFIG2.default.page; // 获取searchPage中所有的page
      var activeItem = this.state.activeItem; // 当前被选中的item
      var setActiveItem = this.setActiveItem; // 设置当前被选中的item
      ...
      return _react2.default.createElement(
        ...
        page.map(function (item, index) {
          return _react2.default.createElement(_item2.default, {
            ...
            setActiveItem: setActiveItem.bind(_this2),
            setPage: setPage.bind(_this2),
            setScrollY: _this2.setScrollY.bind(_this2)
          });
        })
      );
    }
...
/***/ "./src/component/components/footer/item.jsx":
/*!**************************************************!*\
  !*** ./src/component/components/footer/item.jsx ***!
  \**************************************************/
/*! no static exports found */
...
var Item = function (_Component) {
  ...
  _createClass(Item, [{
    ...
    // 点击事件: 更改当前被选中的footer选项卡, 跳转至相应的搜索页面
    value: function handleClick(item, page) {
      var _this2 = this;

      this.props.setActiveItem(item);
      this.props.setPage(page);
      window.setTimeout(function () {
        _this2.props.setScrollY();
      }, 0);
    }
  }, {
    key: 'render',
    value: function render() {
      var item = this.props.page.pageName; // 页脚item文本
      var icon = this.props.page.icon; // 对应的icon
      var activeItem = this.props.activeItem; // 接收当前被选中的item

      var page = item; // 页面
      var isActive = item === activeItem; // 判断该item是否被选中
      var activeCls = isActive ? 'active-item' : ''; // 设置相应样式

      return _react2.default.createElement(
        'div',
        {
          className: 'footer-item ' + activeCls,
          onClick: this.handleClick.bind(this, item, page)
        },
...
/***/ "./src/component/components/header/index.css":
/*!***************************************************!*\
  !*** ./src/component/components/header/index.css ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/component/components/header/index.jsx":
/*!***************************************************!*\
  !*** ./src/component/components/header/index.jsx ***!
  \***************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.css */ "./src/component/components/header/index.css");
...
var Header = function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function handleClick() {
      var key = this.props.activeSearchPage;
      var searchPageScrollY = this.props.searchPageScrollY;

      this.props.showSearchPage();

      window.setTimeout(function () {
        window.scrollTo(0, searchPageScrollY[key]);
      }, 0);
    }
  }, {
    key: 'render',
    value: function render() {
      var activeSearchPage = this.props.activeSearchPage; // 获取详情页对应的搜索页

      var detailPageInfo = (0, _util.getPageInfo)(activeSearchPage).detailPage; // 获取详情页信息
      var returnBtnTxt = detailPageInfo.returnBtnTxt; // 获取头部返回按钮文本
      var headerText = detailPageInfo.headerText; // 获取头部文本
...
/***/ "./src/component/components/list/index.css":
/*!*************************************************!*\
  !*** ./src/component/components/list/index.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/component/components/list/index.jsx":
/*!*************************************************!*\
  !*** ./src/component/components/list/index.jsx ***!
  \*************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.css */ "./src/component/components/list/index.css");

var _item = __webpack_require__(/*! ./item */ "./src/component/components/list/item.jsx");
...
var List = function (_Component) {
  ...
  _createClass(List, [{
    ...
    // 显示详情页
    value: function showDetailPage(item) {
      this.props.showDetailPage(item);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var activePage = this.props.page; // 当前活动页
      var arr = this.props.arr[(0, _util.getActivePageName)(activePage)]; // 包含当前活动页列表信息的数组

      var pageLoadingText = _CONFIG2.default.pageLoading.text; // 页面加载中文本
      var noSearchResource = _CONFIG2.default.noSearchResource.text; // 无相关搜索记录文本
      ...
      return _react2.default.createElement(
        ...
        arr.map(function (item, index) {
          return _react2.default.createElement(_item2.default, {
            item: item,
            key: index,
            showDetailPage: _this2.showDetailPage.bind(_this2),
...
/***/ "./src/component/components/list/item.jsx":
/*!************************************************!*\
  !*** ./src/component/components/list/item.jsx ***!
  \************************************************/
/*! no static exports found */
...
var Item = function (_Component) {
  ...
  _createClass(Item, [{
    ...
    key: 'render',
    value: function render() {
      var activePage = (0, _util.getPageInfo)(this.props.activePage).pageName; // 获取活动页名称
      var item = this.props.item; // 获取列表item的信息
      // 通用
      var img = item.image || item.images.small; // 获取图片
      var title = item.title || '无相关标题信息'; // 获取title
      var tags = item.tags || []; // 获取tags
      var rating = item.rating.average || '无相关评分信息';

      switch (activePage) {
        case _CONFIG2.default.page[0].pageName:
          var authorArr = item.author.length ? item.author : ['无相关作者信息'];
          var author = authorArr.length > 1 ? authorArr[0] + ' \u7B49' : authorArr[0];
          var pubdate = item.pubdate || '无相关出版时间信息';
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                { height: '100%' },
                _react2.default.createElement('img', { src: img, alt: '\u5C01\u9762', className: 'item-img' })
              )
            ),
            _react2.default.createElement(
              'div',
              ...
              _react2.default.createElement(
                'span',
                { className: 'item-info-tt' },
                '\u540D\u79F0: ',
                title
              ),
              _react2.default.createElement(
                'div',
                { className: 'item-info-tags' },
              ...
              _react2.default.createElement(
                'span',
                { className: 'item-info-author' },
                '\u4F5C\u8005: ',
                author
              ),
              _react2.default.createElement(
                'span',
                { className: 'item-info-rating' },
                '\u8BC4\u5206: ',
                rating
              ),
              _react2.default.createElement(
        ...
        case _CONFIG2.default.page[1].pageName:
          var genres = item.genres || []; // 获取genres
          var casts = item.casts || []; // 获取演员数组
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'item-info-casts' },
                casts.map(function (item, index) {
                  return _react2.default.createElement(
                    'span',
                    { className: 'casts-item', key: index },
                    item.name
                  );
                })
              ),
        ...
        case _CONFIG2.default.page[2].pageName:
          var authorMusic = item.author ? item.author[0] : { name: '无相关作者信息' };
...
/***/ "./src/component/components/search/index.css":
/*!***************************************************!*\
  !*** ./src/component/components/search/index.css ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/component/components/search/index.jsx":
/*!***************************************************!*\
  !*** ./src/component/components/search/index.jsx ***!
  \***************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.css */ "./src/component/components/search/index.css");
...
var Search = function (_Component) {
  ...
  // 键盘KeyUp事件, 监听并改变搜索文本, 若监听到Enter则调用searchEvent
  ...
  _createClass(Search, [{
    ...
    value: function handleKeyUpEvent(e) {
      ...
      // 这里让我十分苦恼, 点击时state中的searchText总是少获取一次keyup事件, 所以这里不得不用了一下异步的形式来保持e.target.value与state.searchText保持同步
      window.setTimeout(function () {
        _this2.setState({
        ...
        if (keyCode === 13) {
          var searchType = _this2.props.searchType; // 获取搜索类型
          var defaultSearchArr = (0, _util.getPageInfo)(searchType).searchPage.defaultSearch; // 获取默认搜索文本数组
          var rdmDefaultSearch = defaultSearchArr[Math.floor(Math.random() * defaultSearchArr.length)]; // 随机获取默认搜索内容
          var _searchText = _this2.state.searchText || rdmDefaultSearch; // 获取搜索文本, 为空时则搜索默认文本

          _this2.searchEvent(searchType, _searchText, 0);
        }
      }, 0);
    }

    // 点击监听事件, 若点击则提交包含着对应搜索信息的json中的数组

  }, {
    key: 'searchEvent',
    value: function searchEvent(searchType, searchText, start) {
      var _this3 = this;

      this.props.onSubmitSearchText(this.state.searchText);

      (0, _util.getJson)(searchType, searchText, start, function (json) {
        var searchResultArrName = (0, _util.getPageInfo)(searchType).searchPage.searchResultArrName;
        _this3.props.onSubmit(json[searchResultArrName]);
      });
    }
  }, {
    key: 'render',
    value: function render() {
      var searchType = this.props.searchType; // 获取搜索类型

      var placeholder = (0, _util.getPlaceholder)(searchType); // 获取placeholder
      var defaultSearchArr = (0, _util.getPageInfo)(searchType).searchPage.defaultSearch; // 获取默认搜索文本数组
      var rdmDefaultSearch = defaultSearchArr[Math.floor(Math.random() * defaultSearchArr.length)]; // 随机获取默认搜索内容
      var searchText = this.state.searchText || rdmDefaultSearch; // 获取搜索文本, 为空时则搜索默认文本
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', {
          ...
          onClick: this.searchEvent.bind(this, searchType, searchText, 0)
        })
      );
    }
  }]);
...
/***/ "./src/component/page/detail-page/index.jsx":
/*!**************************************************!*\
  !*** ./src/component/page/detail-page/index.jsx ***!
  \**************************************************/
/*! no static exports found */
...
var _header = __webpack_require__(/*! ../../components/header */ "./src/component/components/header/index.jsx");
...
/***/ "./src/component/page/search-page/index.css":
/*!**************************************************!*\
  !*** ./src/component/page/search-page/index.css ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./src/component/page/search-page/index.jsx":
/*!**************************************************!*\
  !*** ./src/component/page/search-page/index.jsx ***!
  \**************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./index.css */ "./src/component/page/search-page/index.css");

var _search = __webpack_require__(/*! ../../components/search */ "./src/component/components/search/index.jsx");

var _search2 = _interopRequireDefault(_search);

var _list = __webpack_require__(/*! ../../components/list */ "./src/component/components/list/index.jsx");

var _list2 = _interopRequireDefault(_list);

var _footer = __webpack_require__(/*! ../../components/footer */ "./src/component/components/footer/index.jsx");
...
var SearchPage = function (_Component) {
  ...
  function SearchPage() {
    ...
    _this.state = {
      searchType: (0, _util.getActivePageName)(), // 搜索类型
      searchText: '', // 搜索文本
      arr: {}, // 列表数组对象: arr: {'图书': [...], '电影': [...], '音乐': [...] or more...}
      startY: 0, // 记录滑屏事件的初始y坐标
      moveY: 0, // 记录滑屏事件过程中的y坐标
      refreshState: {}, // 下拉刷新状态, 格式同arr
      loadmoreState: {}, // 上拉加载状态, 格式同arr
      loadmoreSwitch: {}, // 这个主要是为了防止用户上拉加载时发生多次请求, 格式同arr
      listStartOffset: {}, // 列表开始查询的offset, 格式同arr
      scrollY: {}
    };
    _this.initList();
    return _this;
  ...
  _createClass(SearchPage, [{
    ...
    value: function initList() {
      ...
      var pageNameArr = (0, _util.getAllPageName)();

      var _loop = function _loop() {
        var key = pageNameArr[i];
        var arr = _this2.state.arr;
        var defaultSearchArr = (0, _util.getPageInfo)(key).searchPage.defaultSearch;
        var defaultSearch = defaultSearchArr[0];

        var refreshState = _this2.state.refreshState;
        var loadmoreState = _this2.state.loadmoreState;
        var loadmoreSwitch = _this2.state.loadmoreSwitch;
        var listStartOffset = _this2.state.listStartOffset;
        var scrollY = _this2.state.scrollY;

        refreshState[key] = _CONFIG2.default.refresh.state.prepare;
        loadmoreState[key] = _CONFIG2.default.loadmore.state.prepare;
        loadmoreSwitch[key] = true;
        listStartOffset[key] = 0;
        scrollY[key] = 0;

        (0, _util.getJson)(key, defaultSearch, 0, function (json) {
          var searchResultArrName = (0, _util.getPageInfo)(key).searchPage.searchResultArrName;
          arr[key] = json[searchResultArrName];
          _this2.setState({
            arr: arr,
    ...
    // 提交最新的搜索结果数组到this.state.arr的对应key中

  }, {
    key: 'onSubmit',
    value: function onSubmit(searchResultArr) {
      var activePage = this.props.activeSearchPage;

      var arr = this.state.arr;
      var loadmoreState = this.state.loadmoreState;
      var loadmoreSwitch = this.state.loadmoreSwitch;
      var offset = this.state.listStartOffset;

      arr[(0, _util.getActivePageName)(activePage)] = searchResultArr;
      loadmoreState[activePage] = _CONFIG2.default.loadmore.state.prepare;
      loadmoreSwitch[activePage] = true;
      offset[activePage] = 0;

      this.setState({
        arr: arr,
        loadmoreSwitch: loadmoreSwitch,
        listStartOffset: offset
      });
    }
    ...
    key: 'onSubmitSearchText',
    value: function onSubmitSearchText(str) {
      this.setState({
        searchText: str
      });
    }
    ...
    value: function setPage(page) {
      this.props.setActiveSearchPage(page);
    ...
    value: function handleTouchMove(e) {
      ...
      var touch = e.touches[0];
      var moveY = touch.pageY - this.state.startY; // move时的Y坐标
      var key = this.state.searchType;

      // 如果滚动条滑动到顶部 且 还在继续下拉菜单时 触发下拉刷新事件
      if (window.scrollY === 0 && moveY >= 0) {
        e.preventDefault();

        this.refs.listWrapper.style.top = moveY + 'px';

        this.setState({
          moveY: moveY
        });

        // if 下拉至40px时, 触发刷新事件, 下拉至???会触发??? ,else 不触发刷新事件
        if (moveY >= 40) {
          var _refreshState = this.state.refreshState;

          _refreshState[key] = _CONFIG2.default.refresh.state.start;

          this.setState({
            refreshState: _refreshState
          });

          if (moveY >= 0.7 * window.innerHeight) {
            this.refs.egg.style.display = 'block';
          }
        } else {
          var _key = this.state.searchType;
          var _refreshState2 = this.state.refreshState;

          _refreshState2[_key] = _CONFIG2.default.refresh.state.prepare;

          this.setState({
            refreshState: _refreshState2
          });
        }
      }

      // 菜单滚动至屏幕底部 且 加载更多开关为true时, 触发加载更多事件
      if (window.scrollY + window.innerHeight === document.body.scrollHeight && this.state.loadmoreSwitch[key] === true) {
        var searchType = this.state.searchType; // 获取搜索类型
        var defaultSearchArr = (0, _util.getPageInfo)(searchType).searchPage.defaultSearch; // 获取默认搜索文本数组
        var rdmDefaultSearch = defaultSearchArr[Math.floor(Math.random() * defaultSearchArr.length)]; // 随机获取默认搜索内容
        var searchText = this.state.searchText || rdmDefaultSearch; // 获取搜索文本
        var offset = this.state.listStartOffset; // 获取列表的offset
        var _loadmoreState = this.state.loadmoreState;
        var _loadmoreSwitch = this.state.loadmoreSwitch;
        var _arr = this.state.arr; // 获取列表信息数组

        offset[searchType] = offset[searchType] + _CONFIG2.default.searchListCount;
        _loadmoreState[searchType] = _CONFIG2.default.loadmore.state.loading;
        _loadmoreSwitch[searchType] = false;

        this.setState({
          listStartOffset: offset,
          loadmoreState: _loadmoreState,
          loadmoreSwitch: _loadmoreSwitch
        });

        (0, _util.getJson)(searchType, searchText, this.state.listStartOffset[searchType], function (json) {
          if (_this3.state.listStartOffset[searchType] + _CONFIG2.default.searchListCount >= json.total) {
            _loadmoreState[searchType] = _CONFIG2.default.loadmore.state.loadAll;
            _loadmoreSwitch[searchType] = false;
            ...
            _arr[searchType] = _arr[searchType].concat(json[searchResultArrName]);
            _loadmoreState[searchType] = _CONFIG2.default.loadmore.state.prepare;
            _loadmoreSwitch[searchType] = true;
    ...
    value: function handleTouchEnd(e) {
      ...
      var searchType = this.state.searchType; // 搜索类型
      var refreshState = this.state.refreshState;
      var scrollY = this.state.scrollY;

      scrollY[searchType] = window.scrollY;

      this.props.getSearchPageScrollY(scrollY);
      ...
      if (refreshState[searchType] === _CONFIG2.default.refresh.state.prepare) {
      ...
      } else if (refreshState[searchType] === _CONFIG2.default.refresh.state.start) {
        var defaultSearchArr = (0, _util.getPageInfo)(searchType).searchPage.defaultSearch; // 获取默认搜索文本数组
        var rdmDefaultSearch = defaultSearchArr[Math.floor(Math.random() * defaultSearchArr.length)]; // 随机获取默认搜索内容
        var searchText = this.state.searchText || rdmDefaultSearch; // 搜索文本
        var _arr2 = this.state.arr; // 列表信息数组
        var offset = this.state.listStartOffset;

        refreshState[searchType] = _CONFIG2.default.refresh.state.refreshing;
        offset[searchType] = 0;
        ...
        this.refs.listWrapper.style.top = 40 + 'px';

        (0, _util.getJson)(searchType, searchText, this.state.listStartOffset[searchType], function (json) {
          if (_this4.state.listStartOffset[searchType] + _CONFIG2.default.searchListCount < json.total) {
            var _loadmoreState2 = _this4.state.loadmoreState;
            var _loadmoreSwitch2 = _this4.state.loadmoreSwitch;

            _loadmoreState2[searchType] = _CONFIG2.default.loadmore.state.prepare;
            _loadmoreSwitch2[searchType] = true;

            _this4.setState({
              loadmoreState: _loadmoreState2,
              loadmoreSwitch: _loadmoreSwitch2
            });
          }

          var searchResultArrName = (0, _util.getPageInfo)(searchType).searchPage.searchResultArrName;

          _arr2[searchType] = json[searchResultArrName];

          refreshState[searchType] = _CONFIG2.default.refresh.state.complete;
          ...
          // 500ms后refreshState改变状态
          window.setTimeout(function () {
            _this4.refs.listWrapper.style.top = 0;

            refreshState[searchType] = _CONFIG2.default.refresh.state.prepare;
      ...
      this.refs.egg.style.display = 'none';
    }
  }, {
    key: 'goToTop',
    ...
    key: 'componentDidMount',
    value: function componentDidMount() {
      var listContainer = this.refs.listContainer;

      listContainer.addEventListener('touchstart', this.handleTouchStart.bind(this), false);
      listContainer.addEventListener('touchmove', this.handleTouchMove.bind(this), false);
      listContainer.addEventListener('touchend', this.handleTouchEnd.bind(this), false);
    }
    ...
    value: function componentWillUnmount() {
      ...
      listContainer.removeEventListener('touchstart', this.handleTouchStart.bind(this));
      listContainer.removeEventListener('touchmove', this.handleTouchMove.bind(this));
      listContainer.removeEventListener('touchend', this.handleTouchEnd.bind(this));
    }
  }, {
    key: 'render',
    value: function render() {
      var activePage = this.props.activeSearchPage; // 获取当前的活动搜索页面

      var refreshText = this.state.refreshState[activePage].text; // 获取下拉刷新文本
      var loadmoreText = this.state.loadmoreState[activePage].text; // 获取上拉加载文本
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'search-container', ref: 'searchContainer' },
          _react2.default.createElement(_search2.default, {
            searchType: this.state.searchType,
            onSubmit: this.onSubmit.bind(this),
            onSubmitSearchText: this.onSubmitSearchText.bind(this)
          }),
          _react2.default.createElement(
            'div',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'egg', ref: 'egg' },
                _react2.default.createElement(
                  'div',
                  null,
                  'Congratulations!!!You have just found the Easter egg!!!'
                ),
                _react2.default.createElement(
                  'div',
                  null,
        ...
        _react2.default.createElement('i', { className: 'gototop iconfont icon-top', onClick: this.goToTop.bind(this) }),
        _react2.default.createElement(_footer2.default, { setPage: this.setPage.bind(this), scrollY: this.state.scrollY })
      );
    }
  }]);
...
/*!**************************!*\
  !*** ./src/util/util.js ***!
  \**************************/
/*! exports provided: getPageInfo, getAllPageName, getActivePageName, getPlaceholder, getJson */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getPageInfo", function() { return getPageInfo; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getAllPageName", function() { return getAllPageName; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getActivePageName", function() { return getActivePageName; });
 ...
 * @return   {string}              URL
 */
function getURL (type, text, start) {
  const pageInfo = getPageInfo(type)
  const searchURL = pageInfo.searchPage.searchURL
  const offset = start || 0

  return searchURL + `?q=${text}&start=${offset}&count=${_CONFIG__WEBPACK_IMPORTED_MODULE_1__["default"].searchListCount}`
}
...
function getPageInfo (pageName) {
  ...
  for (let i = 0; i < pageList.length; i++) {
    if (pageName === pageList[i].pageName) {
      return pageList[i]
    }
  }

  console.log(new Error('PageName Is Wrong!!! Please Check It In CONFIG!!!'))
...
function getAllPageName () {
  ...
  for (var i = 0; i < _CONFIG__WEBPACK_IMPORTED_MODULE_1__["default"].page.length; i++) {
    pageNameArr.push(_CONFIG__WEBPACK_IMPORTED_MODULE_1__["default"].page[i].pageName)
  }
 ...
 * @return   {string}                    活动页面
 */
function getActivePageName (pageName) {
  const activePageName = pageName || _CONFIG__WEBPACK_IMPORTED_MODULE_1__["default"].activePageName

  return getPageInfo(activePageName).pageName
}
...
function getPlaceholder (searchType) {
  const pageInfo = getPageInfo(searchType)

  return pageInfo.searchPage.searchPlaceholder
}
 ...
 * @return   json
 */
function getJson (type, text, start, callback) {
  const URL = getURL(type, text, start) // 取到请求的url

  fetch_jsonp__WEBPACK_IMPORTED_MODULE_0___default()(URL)
    .then(response => {
